 ...
 * from other modules only through its {@code xxx.api} package. Scoped to {@code infrastructure} and
 * {@code origination} (and, as future milestones add them, {@code workflow}/{@code verification}/
